...
@app.route('/tutorials/git', methods=["POST"])
#@cross_origin(origins=["http://localhost:8080"]) no longer needed, but for future reference if required
def returnTutorialData():
    return jsonify(testGitInfo)
